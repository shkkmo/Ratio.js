    ...
    Ratio.prototype = {
		...
		numerator : function(val){
			if(typeof val !== "undefined"){
				this.n = Ratio.parse(val).valueOf();
			}
			return this.n;
		},
		denominator : function(val){
			if(typeof val !== "undefined"){
				this.d = Ratio.parse(val).valueOf();
				this.correctRatio();
			}
			return this.d;
		},
        ...
        correctRatio : function () {
            ...
            this.d = +Math.abs(b);
            this.n = Ratio.getNumeratorWithSign(a, (b || 1));
            if (this.d && this.alwaysReduce) {
         ...
         **/
        valueOf : function () {
            var arr = Ratio.simplifyENotation(this.n, this.d);
            return arr[0] / arr[1];
        },
        /**
        ...
        toLocaleString : function () {
            ...
            if (isNaN(val)) {
                str = "NaN";
            } else if (val % 1 === 0 || this.d === 1 || !isFinite(val % 1)) {
                str = String(val);
            } else if (1 < Math.abs(val)) {
                x = parseInt(val, 10);
                str = x + " " + Math.abs(this.n % this.d) + String(this.divSign) + this.d;
            } else {
                str = this.n + String(this.divSign) + this.d;
            }
            return str;
        },
        /**
         ...
         **/
        toString : function () {
            return String(this.n + this.divSign + this.d);
        },
        /**
         ...
         **/
        reduce : function () {
            var arr = Ratio.reduce(this.n, this.d);
        ...
        add : function (obj, obj2) {
            ...
            if (this.d === obj.d) {
                ...
                x = Ratio.gcd(this.d, obj.d);
                top = ((this.n * obj.d) + (this.d * obj.n)) / x;
                bottom = (this.d * obj.d) / x;
            }
        ...
        divide : function (obj, obj2) {
            obj = Ratio.getCombinedRatio(obj, obj2);
            return this.clone(this.n * obj.d, this.d * obj.n);
        },
        /**
        ...
        deepEquals : function (obj) {
            return (obj instanceof Ratio) && (this.n === obj.n) &&
            (this.d === obj.d) && (this.divSign === obj.divSign) &&
        ...
        multiply : function (obj, obj2) {
            obj = Ratio.getCombinedRatio(obj, obj2);
            return this.clone(this.n * obj.n, this.d * obj.d);
        },
        /**
        ...
        descale : function (obj, obj2) {
            ...
            return this.clone(this.n / factor, this.d / factor);
        },
        /**
        ...
        pow : function (obj, obj2) {
            ...
            return this.clone(Math.pow(this.n, +power), Math.pow(this.d, +power));
        },
        /**
        ...
        cleanFormat : function () {
            ...
            obj;
            if (re.test(this.n) || re.test(this.d)) {
                return Ratio.parse(this.n, this.d);
            }
            obj = this.clone();
            obj.n = Ratio.getCleanENotation(obj.n);
            obj.d = Ratio.getCleanENotation(obj.d);
            return obj;
        },
        /**
         ...
         **/
        abs : function () {
            return this.clone(Math.abs(this.n));
        },
        /**
         ...
         **/
        mod : function () {
            return this.clone(this.n % this.d, 1);
        },
        /**
         ...
         **/
        reciprocal : function () {
            return this.clone(this.d, this.n);
        },
        /**
         ...
         */
        makeProper : function () {
            return this.clone(this.n % this.d, this.d);
        }
    };
    return Ratio;
}
